...
export const adminNavItems: NavItem[] = [
  ...
  { label: 'Event Proofs', href: '/admin/od-proofs', icon: <ShieldCheck className="h-4 w-4" /> },
  { label: 'OD & Leave Requests', href: '/admin/od-applications', icon: <FileText className="h-4 w-4" /> },

...
export const studentNavItems: NavItem[] = [
  ...
  { label: 'OD & Event Proofs', href: '/dashboard/od-proofs', icon: <ShieldCheck className="h-4 w-4" /> },
...
export const facultyNavItems: NavItem[] = [
  ...
  { label: 'OD & Event Proofs', href: '/faculty-dashboard/od-proofs', icon: <ShieldCheck className="h-4 w-4" /> },
...
export const hodNavItems: NavItem[] = [
  ...
  { label: 'OD & Event Proofs', href: '/hod-dashboard/od-proofs', icon: <ShieldCheck className="h-4 w-4" /> },
...
export const adminNavItems: NavItem[] = [
  ...
  { label: 'OD & Proofs Tracking', href: '/admin/od-proofs', icon: <ShieldCheck className="h-4 w-4" /> },

...
export async function GET(request: NextRequest) {
  ...
  if (isBus) {
    return NextResponse.json({
      ...
      data: {
        ...
        busNo: '5',
        routeNo: 'Route 05',
        routeName: 'College Campus Commuter Route',
        via: 'Campus Transit Route',
        boardingStop: 'Designated Stop',
  ...
  return NextResponse.json({
    ...
    data: {
      ...
      room: 'Allocated Room',
      category: 'Day Outing',
      purpose: 'Official Campus Outing',
      destination: 'Local Transit',
      departureTime: 'Today, Permitted Out-Time',
      curfew: '06:30 PM Today',
      parent: '',
      warden: 'Hostel Warden Office',
      time: new Date().toLocaleDateString('en-GB') + ', ' + new Date().toLocaleTimeString('en-IN', { hour: '2-digit', minute: '2-digit', hour12: true }),
      status: 'SANCTIONED & ACTIVE',
    },
  })

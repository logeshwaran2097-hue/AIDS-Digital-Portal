      ...
      <div className="space-y-6 animate-fade-in">
        ...
        {achievements.length > 0 ? (
          ...
          <div className="bg-white rounded-3xl border border-gray-200/90 shadow-sm p-12 text-center max-w-lg mx-auto">
            <div className="w-16 h-16 rounded-2xl bg-[#F4C430]/20 text-[#b58b10] flex items-center justify-center mx-auto mb-4">
              <Trophy className="w-8 h-8" />
            </div>
            <h3 className="text-base font-black text-[#071A3D]">No Department Achievements Published Yet</h3>
            <p className="text-xs text-gray-500 mt-1.5 leading-relaxed">
              When students or faculty submit verified competition awards, hackathon victories, or research distinctions, they will be listed here.
            </p>
          </div>
        )}
      </div>

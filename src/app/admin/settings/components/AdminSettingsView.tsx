...
export function AdminSettingsView() {
  ...
  // 6c. WhatsApp Gateway Config State (Dormant / Deprecated)
  ...
  const [fast2smsPhoneNumberId, setFast2smsPhoneNumberId] = useState('')
  const [fast2smsMessageId, setFast2smsMessageId] = useState('')
  const [fast2smsTemplateName, setFast2smsTemplateName] = useState('')
  const [notifyAbsentViaWhatsapp, setNotifyAbsentViaWhatsapp] = useState(false)
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 sm:p-7 space-y-5">
              ...
              <div className="space-y-4 text-xs">
                ...
                {/* Save SMS Gateway Settings Button */}

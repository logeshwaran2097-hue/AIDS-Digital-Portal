export default function DashboardLoading() {
  return (
    <div className="space-y-6 animate-pulse p-4 sm:p-6 max-w-7xl mx-auto">
      {/* Top Banner Skeleton */}
      <div className="h-36 rounded-3xl bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 shadow-sm animate-pulse" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 h-80 rounded-3xl bg-white border border-gray-200 p-6 space-y-4 shadow-xs">

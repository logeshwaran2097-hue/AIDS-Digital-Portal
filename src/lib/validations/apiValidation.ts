...
export const studentCompleteOnboardingSchema = z
  .object({
    ...
    sslcDistrict: z.string().max(100).optional().nullable(),
    sslcSchool: z.string().max(250).optional().nullable(),
    sslcMarks: z.union([z.number(), z.string()]).optional().nullable(),
    sslcPercentage: z.union([z.number(), z.string()]).optional().nullable(),
    sslcMedium: z.string().max(50).optional().nullable(),
    hscDistrict: z.string().max(100).optional().nullable(),
    hscSchool: z.string().max(250).optional().nullable(),
    hscMarks: z.union([z.number(), z.string()]).optional().nullable(),
    hscPercentage: z.union([z.number(), z.string()]).optional().nullable(),
    hscCutoff: z.union([z.number(), z.string()]).optional().nullable(),
    hscMedium: z.string().max(50).optional().nullable(),
...
export const completeProfileSchema = z
  .object({
    ...
    classPeriod: z.string().max(500).optional().nullable(),
    bloodGroup: z.string().max(30).optional().nullable(),
    residencyStatus: z.string().max(500).optional().nullable(),
    hostelBlock: z.string().max(100).optional().nullable(),
    roomNo: z.string().max(50).optional().nullable(),
...
export const createFacultySchema = z
  .object({
    ...
    phone: z.string().max(100).optional().nullable(),
    password: z.string().max(100).optional(),
    dateOfBirth: z.string().max(100).optional().nullable(),
    ...
    subjectName: z.string().max(500).optional().nullable(),
    classDay: z.string().max(500).optional().nullable(),
    classPeriod: z.string().max(500).optional().nullable(),
    classTime: z.string().max(2000).optional().nullable(),
    advisorBatch: z.string().max(300).optional().nullable(),
    advisorYear: z.union([z.number(), z.string()]).optional().nullable(),
    advisorSem: z.union([z.number(), z.string()]).optional().nullable(),
    advisorSec: z.string().max(50).optional().nullable(),
    facultyType: z.string().max(100).optional(),
    status: z.string().max(50).optional(),
    labTrainer: z.string().max(200).optional().nullable(),
    ...
    labSubjectName: z.string().max(500).optional().nullable(),
    labSubjectCode: z.string().max(200).optional().nullable(),
    labYear: z.union([z.number(), z.string()]).optional().nullable(),
    labSem: z.union([z.number(), z.string()]).optional().nullable(),
    labDay: z.string().max(500).optional().nullable(),
    labPeriod: z.string().max(500).optional().nullable(),
    labTime: z.string().max(2000).optional().nullable(),
    allocationType: z.string().max(100).optional().nullable(),
  })
  .passthrough()

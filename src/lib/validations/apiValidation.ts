...
export const studentCompleteOnboardingSchema = z
  .object({
    ...
    residencyStatus: z.string().max(255).optional().nullable(),
...
export const odApplicationSubmitSchema = z
  .object({
    ...
    teamMembers: z.string().max(500).optional().nullable(),
    ...
    brochureFile: z.string().max(2000000).optional().nullable(),
    brochureName: z.string().max(200).optional().nullable(),
    registrationProof: z.string().max(2000000).optional().nullable(),
...
export const completeProfileSchema = z
  .object({
    ...
    emailOtp: z.string().max(10).optional(),
    otp: z.string().max(10).optional(),
    challenge: z.string().max(500).optional(),
  })
  .passthrough()

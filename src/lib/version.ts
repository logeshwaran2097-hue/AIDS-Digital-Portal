...
export const APP_RELEASE_HIGHLIGHTS = [
  'Luxury Email Header Refinement: Streamlined the executive email header with a seamless radiant emblem, gold metallic divider ribbons, and clean typography by removing the nested pedestal container and cluttered pills',
  ...
  'Pass Verification Harmonization: Synchronized conductor QR scan verification interface with updated bus routes and clean boarding stop labels',
]

...
export const APP_RELEASE_HIGHLIGHTS = [
  'Admin Portal OD & Leave Register Streamlined: Removed misleading "Class Advisor Review Desk (Advisory Jurisdiction)" orange banner from the Administrator portal (/admin/od-applications) and updated the header subtitle to reflect official institutional administrative registry and department-wide oversight.',
